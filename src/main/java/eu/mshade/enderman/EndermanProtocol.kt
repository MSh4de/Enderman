...
class EndermanProtocol : Protocol() {
    protected val entityMetadataManager: EndermanEntityMetadataManager
    protected val itemStackManager: EndermanItemStackManager
    protected val entityMapper = EndermanEntityMapper()
    protected val objectTransformerRepository = EndermanObjectTransformerRepository(getBlockTransformerRepository())
    ...
    init {
        ...
        getProtocolRegistry().registerOut(ProtocolStatus.PLAY, 0x0E, PacketOutSpawnObject::class.java)
    ...
    override fun getSessionWrapper(channel: Channel): SessionWrapper {
        return EndermanSessionWrapper(channel, getWrapperRepository(), getBlockTransformerRepository(), objectTransformerRepository)
    }
