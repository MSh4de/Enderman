...
class EndermanEntityTypeWrapper : Wrapper<EntityKey, Int>() {
    ...
    init {
        ...
        register(EntityType.ZOMBIFIED_PIGLIN, 57)
        ...
        register(EntityType.ITEM_FRAME, 2)
        register(EntityType.MINECART, 10)
        register(EntityType.MINECART_TNT, 50)
        ...
        register(EntityType.SMALL_FIREBALL, 63)
        register(EntityType.FIREBALL, 64)
