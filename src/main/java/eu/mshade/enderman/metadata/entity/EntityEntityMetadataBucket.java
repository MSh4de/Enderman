...
import eu.mshade.enderman.metadata.entity.type.EntityPropertiesEntityMetadataWrapper;


public class EntityEntityMetadataBucket extends EntityMetadataBucket {

    public EntityEntityMetadataBucket() {
        this.registerEntityMetadata(0, new EntityPropertiesEntityMetadataWrapper(), EntityMetadataType.ON_FIRE, EntityMetadataType.CROUCHED, EntityMetadataType.SPRINTING, EntityMetadataType.HANDLING, EntityMetadataType.INVISIBLE);
